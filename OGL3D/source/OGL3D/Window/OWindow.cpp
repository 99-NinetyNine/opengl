...
OWindow::OWindow()
{
	...
	m_handle=CreateWindowEx(NULL,MAKEINTATOM(classId), L"OpenGL",WS_OVERLAPPED | WS_CAPTION | WS_SYSMENU, CW_USEDEFAULT, CW_USEDEFAULT, rc.right - rc.left, rc.bottom - rc.top, NULL, NULL, NULL, NULL);
	assert(m_handle);
